...
//  for(int i = 0; i < 3; i++){
//    lc.clearDisplay(0);
//    lc.setLed(0, 3, i+5, true);
//    lc.setLed(0, 4, i+5, true);
//    
//    lc.setLed(0, 3, 2-i, true);
//    lc.setLed(0, 4, 2-i, true);
//
//    lc.setLed(0, i+5, 3, true);
//    lc.setLed(0, i+5, 4, true);
//    
//    lc.setLed(0, 2-i, 3, true);
//    lc.setLed(0, 2-i, 4, true);
//
//    delay(animationMultiplier);
//  }
}
